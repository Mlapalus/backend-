                        ...
                        <form>
                            <div class="form-row align-items-center justify-content-center">
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    ...
                                    <input type="text" id="name"  value="name" class="form-control" placeholder="Votre Nom">
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <label for="email"></label>
                                    <input type="text"  id="email" value="email"  class="form-control" placeholder="Votre email">
                                </div>
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                    <label for=""></label>
                                    <a href="#" class="btn_1">Souscrire</a>
                                </div>
                            </div>
                        </form>
                    </div>
